...
class GShaderCode
{
	...
	inline static public function getSamplerFragmentCode(p_repeat:Bool, p_filtering:GTextureFilteringType, p_atf:String):String {
        return "tex ft0, v0, fs0 <2d," + ((p_repeat) ? "repeat" : "clamp") + ((p_atf != "") ? "," + p_atf + "," : ",") + ((p_filtering == GTextureFilteringType.NEAREST) ? "nearest>" : "linear>");
    }
